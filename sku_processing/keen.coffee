...
addEvent = (collection_name, payload) ->
  if process.env.NODE_ENV is 'production'
    new Promise (resolve, reject) ->
      keenio.addEvent collection_name, payload, (err, res) ->
...
fns.addSkuEvent = (payload) ->
  addEvent 'skus', payload

fns.addElasticsearchIndexEvent = (payload) ->
  addEvent 'elasticsearch_index', payload
